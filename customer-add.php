...
if(isset($_POST['customerAdd'])) {
  ...
  $sql = "INSERT INTO user(firstName, lastName, email, password, phone, registeredAt, status) VALUES
  ('$firstName', '$lastName', '$email', MD5('$password'), '$phone', CONVERT_TZ(CURRENT_TIMESTAMP,'+00:00','+03:00'), 1)";
  $result = mysqli_query($conn, $sql);
  if($result) {
    $_SESSION['successMessageCustomer'] = 'Lietotājs veiksmīgi pievienots';
    header("Location: customer");
    exit;
  } else {
    echo "Radusies kļūda pievienojot lietotāju";
    }
  }
}
?>
<div class="container">
  <div class="container-inner">
    <form class="customer-add-form customer-form" action="" method="post">
      <h1>Lietotāja pievienošana</h1>
      ...
      <div class="form-item">
        <label>Vārds</label>
        <input class="product-name-input" type="text" name="firstName" value="<?php if(isset($firstName)) { echo $firstName; }?>"></br>
      ...
      <div class="form-item">
        <label>Uzvārds</label>
        <input class="product-name-input" type="text" name="lastName" value="<?php if(isset($lastName)) { echo $lastName; }?>"></br>
      ...
      <div class="form-item">
        <input class="user-add-btn save-btn" type="submit" name="customerAdd" value="Saglabāt">
      </div>
    </form>
  </div>
</div>
